...
export const satQuestions: Question[] = [
  ...
  ...verbalQuestions,
  ...khanQuestions,
  ...satMathQuestions  // Add all 245 RTF questions
];
...
// Updated statistics with RTF questions included
export const updatedQuestionStats = {
  total: satQuestions.length,
  math: satQuestions.filter(q => q.category === 'math').length,
  verbal: satQuestions.filter(q => q.category === 'verbal').length,
