...
export const satMathQuestions: Question[] = [
  ...
  {
    id: "sat_math_154",
    text: "The sum of two numbers is 150. If one number is x, what is the other number in terms of x?",
    category: "math",
    domain: "Algebra",
    skill: "Algebraic expressions",
    difficulty: "hard",
  ...
  {
    id: "263",
    text: "If the sum of the measures of the interior angles of a polygon is 1,440°, how many sides does the polygon have?",
    category: "math",
    domain: "Geometry and Trigonometry",
    skill: "Polygons",
    difficulty: "hard",
